NOTE: THIS IS A FORKED VERSION FROM THE PUBLIC REDIS-PY REPO. WE'RE ONLY USING THIS
IN LOLA SERVER SO WE CAN AVOID UPGRADING FROM REDIS 2.X (WHICH CELERY DEPENDS ON).

WE USE THE LOLA_MASTER BRANCH AS THE PACKAGE UPLOADED TO NEXUS.
